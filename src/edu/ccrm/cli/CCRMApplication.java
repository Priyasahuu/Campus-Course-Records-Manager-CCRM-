...
public class CCRMApplication {
    ...
    private static void runMainMenu() {
        ...
        mainLoop: while (running) {
            ...
            try {
                ...
                // Enhanced switch (Java 14+) - fallback to classic if needed
                switch (choice) {
    ...
    private static void listStudents() {
        ...
        for (Student student : students) {
            System.out.println(student); // Uses overridden toString()
        }
    ...
    private static void listCourses() {
        ...
        while (index < courses.size()) {
            ...
            // Continue demonstration - skip detailed info for inactive courses
            if (!course.isActive()) {
                continue;
            }
        }
    ...
    private static void showTopStudents() {
        try {
            ...
            // Stream pipeline with lambda expressions
    ...
    private static void showGPADistribution() {
        try {
            ...
            // Complex Stream pipeline for GPA distribution
