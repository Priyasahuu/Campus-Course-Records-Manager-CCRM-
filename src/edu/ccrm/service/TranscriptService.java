...
public class TranscriptService {
    ...
    public TranscriptService() {
        ...
        this.enrollmentService = null; // Will be set via dependency injection
    }
    ...
    // Helper method - would be injected in real application
    private List<Enrollment> getStudentEnrollments(String studentId) {
        // This is a simplified version - in real app would use injected service
